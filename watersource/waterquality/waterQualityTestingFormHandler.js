...
@WaterQualityDecisions("a5de1eff-c555-412d-89ed-8dff26de71a2", "Arghyam Water quality testing Decisions", 100.0, {})
...
class WaterQualityValidationFailureArghyam {
    validate(programEncounter) {
        console.log("came to validate WaterQualityValidationFailureArghyam");
    ...
    static exec(programEncounter, validationErrors) {
        return new WaterQualityValidationFailureArghyam().validate(programEncounter);
    }
}


module.exports = {WaterQualityTestingDecisions, WaterQualityValidationFailureArghyam};
